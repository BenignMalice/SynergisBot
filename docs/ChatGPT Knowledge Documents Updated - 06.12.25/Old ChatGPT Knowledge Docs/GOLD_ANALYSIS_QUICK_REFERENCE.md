...
```
moneybot.macro_context(symbol: "XAUUSD") → Just macro layer
  Returns:
  - DXY (US Dollar Index)
...
moneybot.getMultiTimeframeAnalysis(symbol: "XAUUSD") → Just SMC layer
```

**2-layer analysis system:**
...
📌 Key Levels:
Support: $4,068 (PDL) | $4,072 (Swing Low)
Resistance: $4,115 (PDH) | Equal Highs: $4,115 (liquidity target)
Entry Zone: $4,072-$4,074 (Bull OB) · Stop Loss: $4,068 · Take Profit: $4,095 (TP1, R:R 1:6) | $4,115 (TP2, R:R 1:11)
...
### 5. Multiple Timeframe SMC (Now with M1 for Ultra-Fast Signals)
```
...
M1: Ultra-fast breakeven/partial profit detection ⭐ NEW
```
