...
==================================================
This script modifies the pipeline configuration to:
1. Disable Binance feeds entirely
2. Use MT5 M1 streaming for BTCUSD instead
3. Keep existing M5, M15, H1, H4 MT5 data access
"""
...
def disable_binance_feeds():
    ...
    if old_config in content:
        ...
        print("⚠️ Binance configuration not found in expected format")
...
def enable_mt5_m1_for_btcusd():
    ...
    if 'BTCUSDc' in content:
        ...
        print("⚠️ BTCUSDc not found in MT5 symbols - this should be added manually")
    ...
    if 'M1' in content and 'BTCUSDc' in content:
        ...
        print("⚠️ M1 streaming configuration needs verification")
...
def update_mt5_m1_streaming_config():
    ...
    if old_default in content:
        ...
        print("⚠️ Default symbols configuration not found in expected format")
